...
GPIO.setup(11, GPIO.OUT)  # Rouge
GPIO.setup(13, GPIO.OUT)  # Orange
GPIO.setup(15, GPIO.OUT)  # Vert
GPIO.setup(16, GPIO.OUT)  # Rouge
GPIO.setup(18, GPIO.OUT)  # Orange
GPIO.setup(22, GPIO.OUT)  # Vert
GPIO.setup(29, GPIO.OUT)  # Rouge
GPIO.setup(31, GPIO.OUT)  # Orange
GPIO.setup(33, GPIO.OUT)  # Vert
GPIO.setup(35, GPIO.OUT)  # Rouge
GPIO.setup(37, GPIO.OUT)  # Orange
GPIO.setup(40, GPIO.OUT)  # Vert
...
def set_traffic_light(intersection, traffic_light_state):
    GPIO.output(intersection['red'], GPIO.LOW)
    GPIO.output(intersection['orange'], GPIO.LOW)
    GPIO.output(intersection['green'], GPIO.LOW)
    if traffic_light_state == "red":
        GPIO.output(intersection['red'], GPIO.HIGH)
    elif traffic_light_state == "orange":
        GPIO.output(intersection['orange'], GPIO.HIGH)
    elif traffic_light_state == "green":
        GPIO.output(intersection['green'], GPIO.HIGH)
